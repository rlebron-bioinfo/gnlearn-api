...
from src.classes import Populate, All_Genesets, Geneset_Cls, All_Datasets, Dataset_Cls, All_Graphs, Graph_Cls
...
api.add_resource(All_Graphs, '/graphs')
api.add_resource(Graph_Cls, '/graphs/<int:code>')
